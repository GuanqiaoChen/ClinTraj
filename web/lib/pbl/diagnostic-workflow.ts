...
export const workflowStages: WorkflowStage[] = [
  {
    id: 'hypotheses', index: 0, label: '假设', title: '提出假设，优先共享检查',
  ...
  {
    id: 'converge', index: 3, label: '证据', title: '保留证据，终止不支持的分支',
...
const nodeDefinitions: NodeDefinition[] = [
  {
    id: 'presentation', kind: 'evidence', title: '症状与暴露史',
    summary: '慢性呼吸道症状及烟草暴露', status: 'complete', statusLabel: '初始证据',
  ...
  },
  {
    ...
    rationale: '由新获得的多痰和反复感染线索提出，不在已有预设全部假设。',
  ...
  },
  {
    ...
    details: ['复核两次肺功能质量及持续气流受限，整合症状和烟草暴露。', '结合纵向记录和病史，当前不支持哮喘作为当前主导诊断；保留新证据触发重评的可能。', '复核阴性影像与心源性评估，诊断确认权保留给医生。'],
